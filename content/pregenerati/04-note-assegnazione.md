---
title: "Note sull'Assegnazione"
---

# Note sull'Assegnazione

I personaggi creano dinamiche di gruppo specifiche. Karl (il leader) e Friedrich (il giovane) sono la coppia più esplosiva — il capo che ha dato gli ordini e il ragazzo che avrebbe potuto fermarli. Lorenz (il tiratore) e August (l'incendiario) sono i due esecutori materiali. Heinrich (il gigante) e Wilhelm (lo scrittore) rappresentano la brutalità e l'intelletto.
...
Ogni cacciatore è anche la preda.